program oxmodel
   ...
   integer maxzanz, maxtimeanz   !needed for the dimensions of the arrays below
   ...
   real JO2log_array(24, 30, 40, 5)   !lookup table für log(JO2)array
   real JO3log_array(24, 30, 40, 5)   !lookup table für log(JO3)
   ...
   real lon,lat !longitude and latitude of the  model run (degree)
   ...
   do ti=2, integrationtime
     ...
     do zi=1, zanz
       ...
       !write(*,*) z(zi),sza(ti),topo3(ti-1,zi)
...
JO2 = make_JO2(jgridz,jgridzanz,jgridsza,jgridszaanz,jgridtopo3,jgridtopo3anz,jgridalbedo,jgridalbedoanz,&
 ...
 &JO3log_array,z(zi),sza(ti),topo3(ti-1,zi),albedo)
       !write(*,*) ti, zi, KO_O2, KO_O3, JO2, JO3
       ...
       !write(*,*) ox(ti,zi), o3(ti,zi), o(ti,zi)
     enddo    
